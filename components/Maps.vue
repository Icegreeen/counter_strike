        ...
        <ul class="mt-8 grid grid-cols-1 gap-4 lg:grid-cols-3">
          <li>
            <a href="#" class="group relative block">
              <img
                src="~/assets/images/map/mirage.png"
                alt=""
                class="rounded-lg aspect-square w-full object-cover transition duration-500 group-hover:opacity-90"
              />
          ...
          <li>
            <a href="#" class="group relative block">
              <img
                src="~/assets/images/map/dust3.png"
                alt=""
                class="rounded-lg aspect-square w-full object-cover transition duration-500 group-hover:opacity-90"
              />
